    ...
    <div className="flex items-end gap-0 overflow-visible flex-nowrap">
            ...
            <div className="p-2 w-40">
              ...
              {SHAPES.map((s) => (
                <button
                  key={s.val}
                  onClick={() => {
                    insertShape(editor, s.html)
                    setShowShapeDD(false)
                  }}
      ...
      <RGroup label="Symbols">
        ...
        <div className="relative" ref={equationRef}>
          ...
          <DropdownWrapper
            open={showEquationDD}
            onClose={() => setShowEquationDD(false)}
            ...
            <div className="p-2 w-40 max-h-52 overflow-y-auto">
              ...
              {EQUATIONS.map((eq) => (
                <button
                  key={eq.val}
                  onClick={() => {
                    insertEquation(editor, eq.val)
                    setShowEquationDD(false)
                  }}
