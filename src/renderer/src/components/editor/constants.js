...
export const SHAPES = [
  {
    label: '★ Star',
    val: 'star',
    html: '<span style="font-size:24px;color:#eab308;display:inline-block;vertical-align:middle;">★</span>'
  },
  {
    label: '➔ Arrow',
    val: 'arrow',
    html: '<span style="font-size:20px;color:#2563eb;display:inline-block;vertical-align:middle;">➔</span>'
  },
  {
    label: '✔ Checkmark',
    val: 'checkmark',
    html: '<span style="font-size:20px;color:#16a34a;display:inline-block;vertical-align:middle;">✔</span>'
  },
  {
    label: '■ Square',
    val: 'square',
    html: '<span style="font-size:20px;color:#4b5563;display:inline-block;vertical-align:middle;">■</span>'
  },
  {
    label: '● Circle',
    val: 'circle',
    html: '<span style="font-size:20px;color:#dc2626;display:inline-block;vertical-align:middle;">●</span>'
  },
  {
    label: '▲ Triangle',
    val: 'triangle',
    html: '<span style="font-size:20px;color:#7c3aed;display:inline-block;vertical-align:middle;">▲</span>'
  },
  {
    label: '◆ Diamond',
    val: 'diamond',
    html: '<span style="font-size:20px;color:#0891b2;display:inline-block;vertical-align:middle;">◆</span>'
  },
  {
    label: '♥ Heart',
    val: 'heart',
