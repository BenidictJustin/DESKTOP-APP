...
export default function InfoModule() {
  const [appVer, setAppVer] = useState('1.0.3')
  ...
  const developers = [
    {
      ...
      description:
        'Responsible for full-stack system implementation, database scheme mapping, and Electron integration.',
      avatarText: 'A'
    },
    {
      ...
      description:
        'Collaborated with the Dominican College of Tarlac CES office to analyze requirements and define specifications.',
      avatarText: 'DP'
    }
  ]
      ...
      <AnimatedListItem className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-xs mt-1">
            Official CES Office guidelines, organizational hierarchy, and developer credits.
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 relative overflow-hidden">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              We envision the Community Extension and Services (CES) Office as a dynamic and
              responsive center of excellence that leads the Dominican College of Tarlac in
              fostering sustainable community development. Through mutual collaboration, we strive
              to empower marginalized partner communities, transforming both students and residents
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 relative overflow-hidden">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              The CES Office is committed to translating academic concepts into genuine life-based
              learning experiences by engaging in grassroots exposure and community partnership. We
              deliver targeted, impactful services—including educational, health, relief, and
              livelihood initiatives—designed in solidarity with our partners to promote growth,
              self-reliance, and the common good in the light of Dominican values.
            </p>
          </div>
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs mt-0.5">
                  Catholic Education Association of the Philippines pillars supported by JEEPGY
                  Advocates
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Promoting human rights, fairness, and non-violent resolutions to conflicts.'
                },
                {
                  title: 'Care for the Environment',
                  desc: 'Advocating ecological conversion, waste management, and environmental stewardship.'
                },
                {
                  title: 'Active Citizenship',
                  desc: 'Empowering communities to participate in democratic governance and civic engagement.'
                },
                {
                  title: 'Poverty Awareness',
                  desc: 'Solidarity with the poor, addressing immediate food security, and resource distribution.'
                },
                {
                  title: 'Gender Equality',
                  desc: 'Promoting equal dignity and opportunities for all men and women.'
                },
                {
                  title: 'Youth Empowerment',
                  desc: 'Fostering student leadership, creativity, and service participation.'
                }
              ].map((adv, idx) => (
                <div
                  key={idx}
                  className="p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-sig-green/30 transition duration-200"
                >
              ...
              {[
                {
                  ...
                  detail: 'Dominican College of Tarlac, Inc.'
                },
                {
                  role: 'VP of Academic Affairs',
                  name: 'Dr. Augusto R. Dela Cruz',
                  detail: 'Academic Integration'
                },
                {
                  role: 'Head of CES Office',
                  name: 'Mrs. Faithful Anne F. Arugay',
                  detail: 'Head Executive & Admin'
                },
                {
                  role: 'CES Office Coordinator',
                  name: 'Mr. Jonnel B. Manio',
                  detail: 'Operations & Review Coordinator'
                }
              ].map((person, idx) => (
