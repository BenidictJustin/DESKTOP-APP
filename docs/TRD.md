...
- **Stock Tracking Submodule:**
  - Status flags: *Available*, *Low Stock* (quantity $\le$ 10), *Out-of-Stock* (quantity = 0), and *Expired* (expiry date has passed and quantity > 0).
...
- **Report Status:** Monitor status of submissions (*Draft*, *Submitted*, *Returned*, *Approved*).
