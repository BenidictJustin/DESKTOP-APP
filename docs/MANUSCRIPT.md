...
##### C. Department Coordinators
Each academic department has a designated Department Coordinator who uses the system to create and submit narrative reports for their department's community extension activities, upload photos, and track the status of their submitted reports. Access is limited to their assigned department's events and report functions.
