...
This sequence describes logging a donation and inserting or updating batch items in Firestore to maintain expiration isolation and FIFO sorting order.
...
This sequence diagram illustrates the streamlined business process of report creation, optional drafting, submission, admin inspection, and decision paths (Approve vs. Return for Revision).
