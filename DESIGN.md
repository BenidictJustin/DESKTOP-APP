...
- **Canvas White** (`#FFFFFF`): Core background canvas color to maintain clean visual spacing.
- **Surface Soft** (`#F3F4F6`): Quieter section divisions and subtle background.

### Text

- **Ink** (`#111827`): Primary headline and CTA text — high contrast near-black.
- **Charcoal** (`#374151`): Body text on light surfaces.
- **Muted** (`#6B7280`): Secondary text and de-emphasized labels.
